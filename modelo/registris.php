...
$conn = new PDO('mysql:host=localhost;dbname=palomitas_dulces2',"root","");  try {
    ...
    $sql = "INSERT INTO administrador (tipo_doc_usuario, no_doc_usuario, nombre_usuario, apellido_usuario, direccion_usuario, telefono_usuario, correo_usuario, password_usuario) VALUES (:tipo_doc_usuario, :no_doc_usuario, :nombre_usuario, :apellido_usuario, :direccion_usuario, :telefono_usuario, :correo_usuario, :password_usuario)";
